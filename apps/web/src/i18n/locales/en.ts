...
export const en: Dict = {
  ...
  'chat.runError.title.noDeliverable': "Nothing came out this round",
  ...
  'chat.runError.noDeliverableMessage': "The agent finished, but there is no openable file in the project yet, so the task could not be recorded as delivered. Nothing you sent was lost — retry, or add a line about what you want and send again.",
  ...
  'chat.compactContextUnsupported': 'The current runtime does not support manual compaction',
  'chat.compactContextNoSession': 'No resumable agent session yet - send a message first',
  'chat.compactContextBusy': 'Compacting context...',
  'chat.compactContextWaitForRun': 'Wait for the current run to finish',
  'chat.compactContextFailed': 'Could not compact the context',
  'chat.compactSlashDesc': 'Compact the agent session context',
