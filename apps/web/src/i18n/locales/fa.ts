...
export const fa: Dict = {
  ...
  'skillPluginCandidate.confirmIntro': 'با مشارکت، از nexu-io/open-design زیر حساب GitHub خودتان یک fork ساخته می‌شود، پرونده‌های فهرست‌شده در زیر در آن fork عمومی منتشر می‌شوند و سپس یک فرم pull request از پیش پرشده در GitHub باز می‌شود.',
  'skillPluginCandidate.confirmFilesLabel': 'پرونده‌های موجود در pull request:',
  'skillPluginCandidate.confirmRights': 'حق انتشار این مطالب را دارم.',
  'skillPluginCandidate.confirmReviewed': 'این پرونده‌ها را بررسی کرده‌ام و حاوی هیچ داده شخصی یا خصوصی نیستند.',
  'skillPluginCandidate.confirmSubmit': 'ساخت fork و باز کردن pull request',
  ...
  'previewRunStatus.analyzing': 'در حال سامان‌دهی معماری اطلاعات',
  'previewRunStatus.generating': 'در حال ساخت راهکار طراحی',
  'previewRunStatus.verifying': 'در حال اعتبارسنجی تحویل',
  'previewRunStatus.succeeded': 'طراحی آماده است',
  'previewRunStatus.failed': 'تحویل نیاز به رسیدگی دارد · در چت دوباره تلاش کنید',
  ...
  'whatsNew.dismissAria': 'بستن تازه‌ها',
