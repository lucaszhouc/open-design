...
export const fa: Dict = {
  ...
  'chat.runError.title.noDeliverable': "در این دور فایلی تولید نشد",
  ...
  'chat.runError.noDeliverableMessage': "عامل کارش را تمام کرد، اما هنوز فایلی که بشود باز کرد در پروژه نیست، بنابراین کار به‌عنوان تحویل‌شده ثبت نشد. هیچ‌چیز از آنچه فرستادید از بین نرفته است — دوباره تلاش کنید یا در یک خط بگویید چه می‌خواهید.",
  ...
  'chat.compactContext': 'فشرده‌سازی زمینه',
  'chat.compactContextUnsupported': 'ران‌تایم فعلی از فشرده‌سازی دستی پشتیبانی نمی‌کند',
  'chat.compactContextNoSession': 'هنوز نشست عامل قابل ازسرگیری وجود ندارد - ابتدا یک پیام بفرستید',
  'chat.compactContextBusy': 'در حال فشرده‌سازی زمینه…',
  'chat.compactContextWaitForRun': 'منتظر بمانید تا اجرای فعلی تمام شود',
  'chat.compactContextFailed': 'فشرده‌سازی زمینه ممکن نشد',
  'chat.compactSlashDesc': 'فشرده‌سازی زمینه نشست عامل',
