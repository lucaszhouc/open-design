...
export const zhCN: Dict = {
  ...
  "project.restoreAutomaticScenario": "使用系统自动场景",
  "project.restoreAutomaticScenarioConfirm": "确认恢复自动场景",
  "project.restoreAutomaticScenarioBusy": "正在恢复…",
  "project.restoreAutomaticScenarioFailed": "无法恢复系统自动场景。请刷新后重试。",
