...
export const zhTW: Dict = {
  ...
  "chat.amrLowBalance.message": "餘額僅剩 {balance}，可能不夠完成這個任務，建議先儲值或升級方案。",
  ...
  "chat.runError.title.balance": "餘額不足",
  ...
  "settings.apiHint":
    "請求會透過本機 daemon 代理送到你設定的 Base URL。Key 只儲存在目前瀏覽器中，並隨提供方請求送出。",
  ...
  "chat.compactContextUnsupported": "目前執行環境不支援手動壓縮",
  "chat.compactContextNoSession": "尚無可續用的工作階段，請先傳送一則訊息",
  "chat.compactContextBusy": "正在壓縮上下文…",
  "chat.compactContextWaitForRun": "請等待目前任務完成",
  "chat.compactContextFailed": "壓縮上下文失敗",
  "chat.compactSlashDesc": "壓縮代理工作階段上下文",
  ...
  "previewRunStatus.analyzing": "正在梳理資訊架構",
  "previewRunStatus.generating": "正在建構設計方案",
  "previewRunStatus.verifying": "正在驗證交付結果",
  "previewRunStatus.succeeded": "設計已就緒",
  "previewRunStatus.failed": "交付需要處理 · 請在對話中重試",
